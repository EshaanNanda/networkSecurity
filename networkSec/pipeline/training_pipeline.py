...
from networkSec.constants.training_pipeline import TRAINING_BUCKET_NAME
...
from networkSec.entity.config_entity import(
...
from networkSec.entity.artifact_entity import (
...
from networkSec.cloud.s3_syncer import S3Sync
...
class TrainingPipeline:
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            data_validation=DataValidationComponent(data_ingestion_artifact=data_ingestion_artifact,data_validation_config=data_validation_config)
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation = DataTransformationComponent(data_validation_artifact=data_validation_artifact,
